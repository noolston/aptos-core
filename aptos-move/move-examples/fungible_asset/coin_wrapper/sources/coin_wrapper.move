...
module coin_wrapper::coin_wrapper {
    ...
    friend coin_wrapper::example_pool;
    ...
    public fun wrapper_address(): address {
        account::create_resource_address(&@coin_wrapper, COIN_WRAPPER_NAME)
    }
    ...
    fun init_module(coin_wrapper_signer: &signer) {
        let (coin_wrapper_signer, signer_cap) =
            account::create_resource_account(coin_wrapper_signer, COIN_WRAPPER_NAME);
    ...
    fun e2e_test(user: &signer, deployer: &signer) acquires WrapperAccount {
